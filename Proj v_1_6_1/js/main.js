...
items[0].onwheel = function() { //////////////////////200521 오전 1시9분 버전1.3 타임라인 수정
...
// 스크롤이 잠금되는 기능
function lockScroll() {
    let scrollPositionE = (document.documentElement.scrollTop + document.body.scrollTop) / (document.documentElement.scrollHeight - document.documentElement.clientHeight);
...
$(document).ready(function() {
    ...
    const setPercent = () => Math.round((win.scrollTop() - 2200) / (doc.height() - win.height()) * 185);
